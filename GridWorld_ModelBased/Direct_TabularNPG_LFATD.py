...
from ACPG.Critic import DirectLFATDCritic
...
if __name__ == '__main__':
    ...
    etap = (args.eta * args.c) / (args.eta + args.c)
    ...
    current_dir = os.path.join(os.path.abspath(os.getcwd()), "Results/Direct_TabularNPG_LFATD/")
